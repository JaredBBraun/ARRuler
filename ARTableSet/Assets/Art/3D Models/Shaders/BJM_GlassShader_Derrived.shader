...
/*SF_DATA;ver:1.37;sub:START;pass:START;ps:flbk:Legacy Shaders/Transparent/Diffuse,iptp:0,cusa:False,bamd:0,cgin:,lico:1,lgpr:1,limd:0,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:3,bdst:7,dpts:2,wrdp:False,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:False,aust:True,igpj:True,qofs:0,qpre:3,rntp:2,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:3138,x:33733,y:32680,varname:node_3138,prsc:2|normal-8103-RGB,emission-8023-OUT,alpha-9545-OUT,refract-9990-OUT;n:type:ShaderForge.SFN_NormalVector,id:6111,x:32083,y:33334,prsc:2,pt:False;n:type:ShaderForge.SFN_Transform,id:2132,x:32275,y:33334,varname:node_2132,prsc:2,tffrom:0,tfto:3|IN-6111-OUT;n:type:ShaderForge.SFN_ComponentMask,id:7007,x:32700,y:33334,varname:node_7007,prsc:2,cc1:0,cc2:1,cc3:-1,cc4:-1|IN-7685-OUT;n:type:ShaderForge.SFN_RemapRange,id:7685,x:32473,y:33334,varname:node_7685,prsc:2,frmn:-1,frmx:1,tomn:0,tomx:1|IN-2132-XYZ;n:type:ShaderForge.SFN_Multiply,id:9990,x:33388,y:33336,varname:node_9990,prsc:2|A-7007-OUT,B-5196-OUT;n:type:ShaderForge.SFN_Slider,id:5196,x:32972,y:33534,ptovrint:False,ptlb:RefractionFactor,ptin:_RefractionFactor,varname:node_5196,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:-1,cur:0,max:1;n:type:ShaderForge.SFN_Tex2d,id:1208,x:32972,y:32661,ptovrint:False,ptlb:MatcapRimRefl,ptin:_MatcapRimRefl,varname:node_1208,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:d8b58c5c88b7594468db418c73d02f45,ntxv:0,isnm:False|UVIN-1951-OUT;n:type:ShaderForge.SFN_Slider,id:4533,x:32489,y:32441,ptovrint:False,ptlb:Transparency,ptin:_Transparency,varname:node_4533,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:1,max:1;n:type:ShaderForge.SFN_ComponentMask,id:638,x:32548,y:32936,varname:node_638,prsc:2,cc1:2,cc2:-1,cc3:-1,cc4:-1|IN-7685-OUT;n:type:ShaderForge.SFN_OneMinus,id:499,x:32722,y:32936,varname:node_499,prsc:2|IN-638-OUT;n:type:ShaderForge.SFN_Slider,id:5131,x:32928,y:33098,ptovrint:False,ptlb:RimSizeRadiusAtFull,ptin:_RimSizeRadiusAtFull,varname:node_5131,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.2640569,max:1;n:type:ShaderForge.SFN_RemapRangeAdvanced,id:7451,x:33298,y:32938,varname:node_7451,prsc:2|IN-499-OUT,IMIN-6479-OUT,IMAX-5131-OUT,OMIN-9020-OUT,OMAX-9326-OUT;n:type:ShaderForge.SFN_Vector1,id:9326,x:33085,y:33247,varname:node_9326,prsc:2,v1:1;n:type:ShaderForge.SFN_Vector1,id:9020,x:33085,y:33178,varname:node_9020,prsc:2,v1:0;n:type:ShaderForge.SFN_Slider,id:6479,x:32928,y:33006,ptovrint:False,ptlb:RimSizeRadiusAtStart,ptin:_RimSizeRadiusAtStart,varname:node_6479,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0,max:1;n:type:ShaderForge.SFN_Clamp01,id:9545,x:33486,y:32938,varname:node_9545,prsc:2|IN-7451-OUT;n:type:ShaderForge.SFN_Color,id:3508,x:32982,y:32473,ptovrint:False,ptlb:Color,ptin:_Color,varname:node_3508,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0,c2:0,c3:0,c4:1;n:type:ShaderForge.SFN_Multiply,id:8023,x:33268,y:32468,varname:node_8023,prsc:2|A-3508-RGB,B-1208-RGB;n:type:ShaderForge.SFN_Tex2d,id:8103,x:33462,y:32353,ptovrint:False,ptlb:BumpMap,ptin:_BumpMap,varname:node_8103,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:ce1e2e6878b04469c955abff91bad522,ntxv:3,isnm:True;n:type:ShaderForge.SFN_NormalVector,id:8106,x:32103,y:32661,prsc:2,pt:True;n:type:ShaderForge.SFN_Transform,id:6120,x:32295,y:32661,varname:node_6120,prsc:2,tffrom:0,tfto:3|IN-8106-OUT;n:type:ShaderForge.SFN_ComponentMask,id:1951,x:32720,y:32661,varname:node_1951,prsc:2,cc1:0,cc2:1,cc3:-1,cc4:-1|IN-5288-OUT;n:type:ShaderForge.SFN_RemapRange,id:5288,x:32493,y:32661,varname:node_5288,prsc:2,frmn:-1,frmx:1,tomn:0,tomx:1|IN-6120-XYZ;proporder:5196-1208-4533-5131-6479-3508-8103;pass:END;sub:END;*/

Shader "ShaderTest/BJM_GlassShader_Derrived" {
    Properties {
        _RefractionFactor ("RefractionFactor", Range(-1, 1)) = 0
        _MatcapRimRefl ("MatcapRimRefl", 2D) = "white" {}
        _Transparency ("Transparency", Range(0, 1)) = 1
        _RimSizeRadiusAtFull ("RimSizeRadiusAtFull", Range(0, 1)) = 0.2640569
        _RimSizeRadiusAtStart ("RimSizeRadiusAtStart", Range(0, 1)) = 0
